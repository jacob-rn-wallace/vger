...
static const vger_mnemonic_entry_t VGER_MNEMONICS[] = {
    ...
    {"RTN", VGER_KEY_RTN, VGER_STEP_OPCODE_ONLY},
    {"X=0?", VGER_KEY_X_EQ_0, VGER_STEP_OPCODE_ONLY},
    {"X#0?", VGER_KEY_X_NE_0, VGER_STEP_OPCODE_ONLY},
    {"X>0?", VGER_KEY_X_GT_0, VGER_STEP_OPCODE_ONLY},
    {"X<0?", VGER_KEY_X_LT_0, VGER_STEP_OPCODE_ONLY},
    {"X=Y?", VGER_KEY_X_EQ_Y, VGER_STEP_OPCODE_ONLY},
    {"X#Y?", VGER_KEY_X_NE_Y, VGER_STEP_OPCODE_ONLY},
    {"X>Y?", VGER_KEY_X_GT_Y, VGER_STEP_OPCODE_ONLY},
    {"X<Y?", VGER_KEY_X_LT_Y, VGER_STEP_OPCODE_ONLY},
    ...
    {"XEQ", VGER_KEY_XEQ, VGER_STEP_OPCODE_LABEL_ARG},
