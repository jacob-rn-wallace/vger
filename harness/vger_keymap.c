...
static const vger_binding_t VGER_BINDINGS[] = {
    ...
    {SDL_SCANCODE_Q, VGER_KEY_X_EQ_0},
    {SDL_SCANCODE_W, VGER_KEY_X_NE_0},
    {SDL_SCANCODE_E, VGER_KEY_X_GT_0},
    {SDL_SCANCODE_T, VGER_KEY_X_LT_0},
    {SDL_SCANCODE_A, VGER_KEY_X_EQ_Y},
    {SDL_SCANCODE_S, VGER_KEY_X_NE_Y},
    {SDL_SCANCODE_D, VGER_KEY_X_GT_Y},
    {SDL_SCANCODE_F, VGER_KEY_X_LT_Y},
